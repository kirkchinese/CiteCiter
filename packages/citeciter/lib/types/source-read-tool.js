...
import { formatSourceSessionRead } from "./observer.js";
...
export function sourceReadPrompt(frozen) {
    const scope = frozen
...
export function createSourceReadTool(options) {
    return defineTool({
        ...
        execute: async (args, exec) => {
            ...
            return { ...result, readScope: options.frozen ? 'inherited-prefix' : 'live-source', events: [...result.events] };
        },
