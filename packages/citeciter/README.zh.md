...
CiteCiter 0.4.1 需要 Node.js `^22.19.0 || >=24.0.0` 与 DSH `>=0.1.1-rc.1 <0.1.1-rc.3`。
...
| 宿主 | CiteCiter 版本 | 状态 |
|---|---|---|
| DSH Web `0.1.1-rc.2` | `0.4.1` | Linux 包、CI、升级与组装 keyless 浏览器检查通过；真实提供方验收未运行 |
...
正式 Desktop 适配已经暂缓，不属于 0.4.1 的受支持升级路径。
...
- CiteCiter 0.4.1 不声明正式 Desktop 安装包兼容性；Windows 与 macOS 原生适配将另行继续。
- 当前没有 TUI 交互适配器。
