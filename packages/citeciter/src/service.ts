...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * @mode emit
     */
    'citeciter/topic-created'(payload: { topic: TopicSummary }): void
    /**
     ...
     * @mode emit
     */
    'citeciter/topic-updated'(payload: { topic: TopicSummary }): void
    /**
     ...
     * @mode emit
     */
    'citeciter/topic-deleted'(payload: Omit<Extract<CiteCiterResponse, { kind: 'deleted' }>, 'kind'>): void
  }
}
...
export interface CiteCiterService {
   ...
   */
  create(request: Extract<CiteCiterRequest, { action: 'create' }>, signal?: AbortSignal): Promise<TopicSnapshot>
  /**
   ...
   * @returns the committed Topic snapshot.
   */
  ask(request: Extract<CiteCiterRequest, { action: 'ask' }>, signal?: AbortSignal): Promise<TopicSnapshot>
  /**
   ...
   */
  delete(
    request: Extract<CiteCiterRequest, { action: 'delete' }>,
    signal?: AbortSignal,
  ): Promise<Extract<CiteCiterResponse, { kind: 'deleted' }>>
}
